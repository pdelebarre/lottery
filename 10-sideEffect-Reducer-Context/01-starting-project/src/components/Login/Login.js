...
const Login = (props) => {
  ...
  const {isValid: emailIsValid} = emailState; //alias - pulling isValid prop - obj destruct.
  const {isValid: passwordIsValid} = passwordState; //pulling isValid prop - obj destruct.
